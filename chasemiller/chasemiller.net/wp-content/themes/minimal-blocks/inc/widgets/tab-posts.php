            ...
            <div class="tabbed-head">
                <ul class="nav nav-tabs nav-tabs-bg" role="tablist">
                    <li role="presentation" class="tab tab-popular active">
                        <a href="#ms-popular" aria-controls="<?php esc_html_e('Popular', 'minimal-blocks'); ?>" role="tab" data-toggle="tab">
                            <span>
                    ...
                    <li class="tab tab-recent">
                        <a href="#ms-recent" aria-controls="<?php esc_html_e('Recent', 'minimal-blocks'); ?>" role="tab" data-toggle="tab">
                             <span class="tab-icon">
