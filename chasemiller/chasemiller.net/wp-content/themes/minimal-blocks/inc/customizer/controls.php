 ...
 */
class Minimal_Blocks_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Minimal_Blocks_Customize_Section_Upsell extends WP_Customize_Section {
